-- in this file we will understand how to work with joining the  sql .
...
SELECT students.name,marks.subject,marks.score FROM students INNER JOIN marks ON students.id=marks.student_id;-- this is for the data which  have been given it will not accept the value of the empty data if data if given in the both data about the table then it will be will in inner joim 
